"""
Django settings for agroEcommerce project.
...
SECRET_KEY = 'django-insecure-b**i_*@g5)jt3n$td3ehiwn2^-x_(*&yu_@wk8blb7$i!1@em_'
...
ROOT_URLCONF = 'agroEcommerce.urls'
...
WSGI_APPLICATION = 'agroEcommerce.wsgi.application'
